...
while (1):
    ...
    url = 'https://api.nytimes.com/svc/search/v2/articlesearch.json?api-key='+key2+'&q=facebook&begin_date=20180329&end_date=20180402&fl=lead_paragraph%2Cabstract%2Cheadline%2Csnippet%2Cweb_url&page='+str(count)
