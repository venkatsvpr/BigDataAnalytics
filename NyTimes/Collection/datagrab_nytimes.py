...
while (1):
    ...
    url = 'https://api.nytimes.com/svc/search/v2/articlesearch.json?api-key='+key2+'&q=facebook&begin_date=20180125&end_date=20180225&fl=lead_paragraph%2Cabstract%2Cheadline%2Csnippet%2Cweb_url&page='+str(count)
    ...
    if (breakflag):
        ...
        break;
    with open("april_3/"+str(count)+".json",'w') as out_json:
